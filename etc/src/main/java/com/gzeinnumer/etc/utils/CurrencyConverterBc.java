...
public class CurrencyConverterBc implements TextWatcher {
    ...
    public CurrencyConverterBc(EditText editText) {
        this.editText = editText;
    }

    public CurrencyConverterBc(EditText editText, StringCallBack stringCallBack) {
        this.editText = editText;
